...
<div class="attendance__list__content">
    ...
    <div class="attendance__list__day-select-box">
        <a class="attendance__list__prev-next-day" href="{{ url('/admin/attendance/list?day=' . $prevDay) }}"><img src="{{ asset('images/image_prev.png') }}" alt="arrow_prev"><span>前日</span></a>
        <div class="attendance__list__this-day-calendar">
            <img src="{{ asset('images/image_calendar.png') }}" alt="calendar">
            <p class="attendance__list__this-day">{{ $current->format('Y/n/d') }}</p>
        </div>
        <a class="attendance__list__prev-next-day" href="{{ url('/admin/attendance/list?day=' . $nextDay) }}"><span>翌日</span><img src="{{ asset('images/image_next.png') }}" alt="arrow_next"></a>
    </div>
